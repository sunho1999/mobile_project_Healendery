    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        type_radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.btn_aerobic){
                    ...
                    Toast.makeText(CalenderActivity.this, "유산소", Toast.LENGTH_LONG).show();
                }

                // 웨이트이면 값을 false로 저장
                else if(checkedId == R.id.btn_weight){
                    now_state.setType(false);
                    Toast.makeText(CalenderActivity.this, "웨이트", Toast.LENGTH_LONG).show();
                }
            }
        });
        goal_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CalenderActivity.this, "목표적기로 이동합니다", Toast.LENGTH_LONG).show();
        ...
        go_db_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CalenderActivity.this, "운동기록을보러 이동합니다", Toast.LENGTH_LONG).show();
                startActivity(intent);
            }
        });
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener()
        {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth)
            {
                ...
                ad.setTitle("확인창");
                ad.setMessage("기분을 적겠습니까?\n" + "운동을 기록하시겠습니까?");

                final EditText et = new EditText(CalenderActivity.this);
                ad.setView(et);

                ad.setPositiveButton("운동기록하기", new DialogInterface.OnClickListener() {
                    @Override
                ...
                ad.setNegativeButton("기분적기", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
